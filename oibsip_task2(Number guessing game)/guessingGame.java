...
class Guess extends JFrame
{
    ...
    public Guess()
    {
        ...
        JLabel j=new JLabel("Number Guessing");
        j.setForeground(Color.RED);
        j.setFont(new Font("tunga",Font.BOLD,27));
        j.setSize(270,40);
